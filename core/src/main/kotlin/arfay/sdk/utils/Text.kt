...
fun Conversable.message(message: String) = sendRawMessage(message)
fun ConversationContext.msg(message: String) = forWhom.message(message)
...
fun Player.sendMessage(text: String) = sendMessage(text)
...
fun Player.msg(text: String) = sendMessage(text)
