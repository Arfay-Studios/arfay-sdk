package net.arfay.sdk.collections
 ...
 */
open class IndexList<E> : LinkedList<E> {

    constructor() : super()

    constructor(elements: Iterable<E>) : super() {
        addAll(elements)
    }
 ...
 */
fun <E> newIndexList() = IndexList<E>()
 ...
 */
inline fun <T> buildIndexList(block: IndexList<T>.() -> Unit): IndexList<T> {
